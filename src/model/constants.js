...
export const HERO_SPEED_RUNNING = 510
export const HERO_SPEED_ROOM_SWITCH_NORMAL = 1000
export const HERO_SPEED_ROOM_SWITCH_CRAZY = 500
export const PLAYER_SPEED_WALKING = 300
export const PLAYER_SPEED_RUNNING = 500

export const HERO_DOOR_OFFSET = 50